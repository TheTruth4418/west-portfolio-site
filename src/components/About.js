function About(){
    return (
        <div className="container-fluid text-center lg-6" id="about">
            <h1 className="p-4" >Single Page App Specialist</h1>
            <p>Hi! My name is William West and I am a Texas based programmer who specializes in Single Page Applications!
            I mainly work with ReactJS but I also am proficient in JavaScript, Ruby on rails, HTML, CSS, SQL, and Bootstrap.
